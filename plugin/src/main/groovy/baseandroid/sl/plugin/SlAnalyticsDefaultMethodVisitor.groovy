...
class SlAnalyticsDefaultMethodVisitor extends AdviceAdapter {

    String methodName

    SlAnalyticsDefaultMethodVisitor(MethodVisitor mv, int access, String name, String desc) {
        super(SlAnalyticsUtil.ASM_VERSION, mv, access, name, desc)
        methodName = name
        if (Logger.debug) {
