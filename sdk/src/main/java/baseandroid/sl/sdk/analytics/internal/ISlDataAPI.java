...
public interface ISlDataAPI extends IFragmentAPI {
     ...
     */
    void enableAutoTrack(List<SlDataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    void disableAutoTrack(List<SlDataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    void disableAutoTrack(SlDataAPI.AutoTrackEventType autoTrackEventType);
     ...
     */
    @Deprecated
    void ignoreAutoTrackEventType(SlDataAPI.AutoTrackEventType autoTrackEventType);
     ...
     */
    @Deprecated
    void ignoreAutoTrackEventType(List<SlDataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    boolean isAutoTrackEventTypeIgnored(SlDataAPI.AutoTrackEventType eventType);

    /**
     * 判断某个 AutoTrackEventType 是否被忽略
     *
     * @param autoTrackEventType SlAnalyticsAutoTrackEventType 中的事件类型，可通过 '|' 进行连接传递
     * @return true 被忽略; false 没有被忽略
     */
    ...
    /**
     * 将所有本地缓存的日志发送到 Sl Analytics.
     */
    void flush();

    /**
     * 以阻塞形式将所有本地缓存的日志发送到 Sl Analytics
     */
    void flushSync();
     ...
     */
    void registerDynamicSuperProperties(SlDataDynamicSuperProperties dynamicSuperProperties);
