...
public class NetworkUtils {
    ...
    public static String networkType(Context context) {
        try {
            // 检测权限
            if (!SlDataUtils.checkHasPermission(context, Manifest.permission.ACCESS_NETWORK_STATE)) {
                return "NULL";
            }
    ...
    private static int toNetworkType(String networkType) {
        if ("NULL".equals(networkType)) {
            return SlDataAPI.NetworkType.TYPE_ALL;
        } else if ("WIFI".equals(networkType)) {
            return SlDataAPI.NetworkType.TYPE_WIFI;
        } else if ("2G".equals(networkType)) {
            return SlDataAPI.NetworkType.TYPE_2G;
        } else if ("3G".equals(networkType)) {
            return SlDataAPI.NetworkType.TYPE_3G;
        } else if ("4G".equals(networkType)) {
            return SlDataAPI.NetworkType.TYPE_4G;
        } else if ("5G".equals(networkType)) {
            return SlDataAPI.NetworkType.TYPE_5G;
        }
        return SlDataAPI.NetworkType.TYPE_ALL;
    }
