...
import baseandroid.sl.sdk.analytics.SlDataFragmentTitle;
import baseandroid.sl.sdk.analytics.internal.ScreenAutoTracker;
import baseandroid.sl.sdk.analytics.visual.model.ViewNode;
...
public class AopUtil {
        ...
        try {
            if (context != null) {
                if (context instanceof Activity) {
                    ...
                    if (view != null) {
                        Object object = view.getTag(R.id.sl_analytics_tag_view_activity);
                        if (object != null) {
        ...
        try {
            ...
            if (fragment instanceof ScreenAutoTracker) {
                ...
                if (trackProperties != null) {
                    ...
                    SlDataUtils.mergeJSONObject(trackProperties, properties);
                }
            }

            if (TextUtils.isEmpty(title) && fragment.getClass().isAnnotationPresent(SlDataFragmentTitle.class)) {
    ...
    public static JSONObject buildTitleAndScreenName(Activity activity) {
        ...
        try {
            ...
            if (activity instanceof ScreenAutoTracker) {
                ...
                JSONObject trackProperties = screenAutoTracker.getTrackProperties();
                if (trackProperties != null) {
                    SlDataUtils.mergeJSONObject(trackProperties, propertyJSON);
                }
            }
        } catch (Exception ex) {
            SlLog.printStackTrace(ex);
    ...
    public static String getViewId(View view) {
        ...
        try {
            idString = (String) view.getTag(R.id.sl_analytics_tag_view_id);
    ...
    public static boolean isViewIgnored(Class viewType) {
        try {
            ...
            List<Class> mIgnoredViewTypeList = SlDataAPI.sharedInstance().getIgnoredViewTypeList();
    ...
    public static boolean isViewIgnored(View view) {
        try {
            ...
            //View 被忽略
            return "1".equals(view.getTag(R.id.sl_analytics_tag_view_ignored));
    ...
    public static Object getFragmentFromView(View view) {
        try {
            if (view != null) {
                String fragmentName = (String) view.getTag(R.id.sl_analytics_tag_view_fragment_name);
                String fragmentName2 = (String) view.getTag(R.id.sl_analytics_tag_view_fragment_name2);
    ...
    public static void addViewPathProperties(Activity activity, View view, JSONObject properties) {
        try {
            ...
            if ((SlDataAPI.sharedInstance().isHeatMapEnabled() || SlDataAPI.sharedInstance().isVisualizedAutoTrackEnabled())
                    && (SlDataAPI.sharedInstance().isHeatMapActivity(activity.getClass()) || SlDataAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass()))) {
            ...
            if (viewNode != null) {
                if (!TextUtils.isEmpty(viewNode.getViewPath())) {
                    if (SlDataAPI.sharedInstance().isVisualizedAutoTrackEnabled() && SlDataAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass())) {
