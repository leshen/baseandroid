 ...
 * Copyright 2015－2020 Sls Data Inc.
 *
...
class RealRequest {
    ...
    private static final String TAG = "Sl.HttpRequest";
    ...
    RealResponse getData(String requestURL, Map<String, String> headerMap) {
        try {
            SlLog.i(TAG, String.format("url:%s,\nmethod:GET", requestURL));
    ...
    private HttpURLConnection getHttpURLConnection(String requestURL, String requestMethod) throws IOException {
        ...
        SSLSocketFactory sslSocketFactory = SlDataAPI.sharedInstance().getSSLSocketFactory();
